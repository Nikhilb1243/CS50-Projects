...
export const DRESS: Record<string, DressDef> = {
  shambler: { eye: 0xc8e0a0, eyeSize: 0.07, eyeSpread: 0.045, eyeY: 0.12, eyeZ: 0.12, drip: 0x2a3018, dripRate: 1.5, crawl: 1 },
  stalker: { eye: 0xf0f0ff, eyeSize: 0.05, eyeSpread: 0.035, eyeY: 0.1, eyeZ: 0.11, drip: 0x1a0606, dripRate: 0.6, crawl: 0.5 },
  crawler: { eye: 0xff4030, eyeSize: 0.06, eyeSpread: 0.04, eyeY: 0.08, eyeZ: 0.12, drip: 0x300808, dripRate: 1.2, crawl: 0.8 },
  knight: { eye: 0x60d0c0, eyeSize: 0.09, eyeSpread: 0.05, eyeY: 0.1, eyeZ: 0.14, drip: 0x1a2a2a, dripRate: 3, crawl: 0.2 },
  mimic: { eye: 0xffd0a0, eyeSize: 0.05, eyeSpread: 0.04, eyeY: 0.12, eyeZ: 0.12, drip: 0x3a1010, dripRate: 1, crawl: 1.4 },
  screamer: { eye: 0xffffff, eyeSize: 0.08, eyeSpread: 0.04, eyeY: 0.1, eyeZ: 0.12, drip: 0x100404, dripRate: 1.4, crawl: 1.2 },
};
